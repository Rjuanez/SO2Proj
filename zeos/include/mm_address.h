...
#define PAG_LOG_INIT_COPY_SPACE (PAG_LOG_INIT_DATA+NUM_PAG_DATA)
#define PAG_LOG_PRIMARY_BUFFER (PAG_LOG_INIT_COPY_SPACE+NUM_PAG_DATA)
#define PAG_LOG_BIG_MEM_MANAGMENT (PAG_LOG_PRIMARY_BUFFER+1)
#define PAG_LOG_INIT_BIG_MEM (PAG_LOG_BIG_MEM_MANAGMENT+1)
#define NUM_PAG_BIG_MEM (TOTAL_PAGES - PAG_LOG_INIT_BIG_MEM)
